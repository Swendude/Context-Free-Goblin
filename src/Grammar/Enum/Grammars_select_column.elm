...
module Grammar.Enum.Grammars_select_column exposing (..)
        ...
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Grammars_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )
